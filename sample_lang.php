    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="d-flex flex-column align-items-center">
                <img id="viewPicture" src="" alt="Student Picture" class="img-thumbnail mb-3" width="150" height="120">
...
<div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body text-center">
                <img id="editPicture" src="" alt="Student Picture" class="img-thumbnail mb-3" width="150" height="120">
                <form id="editForm">
                    <div class="form-group">
    ...
    >
        <div class="modal-content">
            <div class="modal-body text-center font-18">
                ...
                <div class="mb-30 text-center">
                    <img src="vendors/images/error.png" alt="error"/>
                </div>
        ...
        <script src="vendors/scripts/add_sanction.js"></script>
        <script>
