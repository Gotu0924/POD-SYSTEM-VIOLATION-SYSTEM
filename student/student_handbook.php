            ...
            <div class="product-list">
                <ul class="row" style="display: flex; justify-content: center; flex-wrap: wrap; padding: 0; margin: 0;">
                    ...
                    <li class="col-lg-4 col-md-6 col-sm-12" style="margin-bottom: 20px; display: flex; justify-content: center;">
                        <div class="product-box" style="text-align: center;">
                            <div class="product-img">
                                <img ../assets/src="../assets/../assets/vendors/images/section1.jpg" alt="" />
                            </div>
                    ...
                    <li class="col-lg-4 col-md-6 col-sm-12" style="margin-bottom: 20px; display: flex; justify-content: center;">
                        <div class="product-box" style="text-align: center;">
                            <div class="product-img">
                                <img ../assets/src="../assets/../assets/vendors/images/section2.jpg" alt="" />
                            </div>
                            <div class="product-caption">
                    ...
                    <li class="col-lg-4 col-md-6 col-sm-12" style="margin-bottom: 20px; display: flex; justify-content: center;">
                        <div class="product-box" style="text-align: center;">
                            <div class="product-img">
                                <img ../assets/src="../assets/../assets/vendors/images/section3.jpg" alt="" />
                            </div>
                            <div class="product-caption">
                    ...
                    <li class="col-lg-4 col-md-6 col-sm-12" style="margin-bottom: 20px; display: flex; justify-content: center;">
                        <div class="product-box" style="text-align: center;">
                            <div class="product-img">
                                <img ../assets/src="../assets/../assets/vendors/images/section4.jpg" alt="" />
                            </div>
                            <div class="product-caption">
                    ...
                    <li class="col-lg-4 col-md-6 col-sm-12" style="margin-bottom: 20px; display: flex; justify-content: center;">
                        <div class="product-box" style="text-align: center;">
                            <div class="product-img">
                                <img ../assets/src="../assets/../assets/vendors/images/section5.jpg" alt="" />
                            </div>
                            <div class="product-caption">
                    ...
                    <li class="col-lg-4 col-md-6 col-sm-12" style="margin-bottom: 20px; display: flex; justify-content: center;">
                        <div class="product-box" style="text-align: center;">
                            <div class="product-img">
                                <img ../assets/src="../assets/../assets/vendors/images/section6.jpg" alt="" />
                            </div>
                            <div class="product-caption">
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content shadow-lg border-0" style="border-radius: 15px;">
      ...
      <div class="modal-footer d-flex justify-content-center">
		...
		<!-- js -->
		<script ../assets/src="../assets/../assets/vendors/scripts/core.js"></scrip>
