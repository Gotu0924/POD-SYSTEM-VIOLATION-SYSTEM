		...
		<link
			...
			type="image/png"
			sizes="32x32"
			href="../assets/vendors/images/favicon-32x32.png.jpg"
		/>
		<link
			rel="icon"
			type="image/png"
		...
		<link rel="stylesheet" type="text/css" href="../assets/src/styles/loading.css" />
    ...
    <!-- Bootstrap JS and Popper.js (needed for modals) -->
    <script ../assets/src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/2.10.2/umd/popper.min.js"></script>
    <script ../assets/src="https://stackpath.bootstrapcdn.com/bootstrap/5.1.3/js/bootstrap.min.js"></script>
